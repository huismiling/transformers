    ...
    def __post_init__(self):
        ...
        if self.framework == "pt" and is_torch_available():
            ...
            if self.bf16 or self.bf16_full_eval:
                if self.use_cpu and not is_torch_bf16_cpu_available() and not is_torch_tpu_available():
                    ...
                    elif torch.mlu.is_available() and not is_torch_bf16_gpu_available():
                        # gpu
                        raise ValueError(
                            "Your setup doesn't support bf16/mlu."
                        )
        ...
        if (
            ...
            raise ValueError(
                ...
                " (`--fp16_full_eval`) can only be used on MLU or NPU devices."
            )
        ...
        if (
            ...
            raise ValueError(
                ...
                " (`--bf16_full_eval`) can only be used on CUDA, MLU, XPU (with IPEX) or CPU/TPU/NeuronCore devices."
            )
